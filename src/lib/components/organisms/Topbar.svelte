<script lang="ts">
    ...
    let {
        ...
        class: className = '',
        ...rest
    }: HTMLAttributes<HTMLElement> & { children: Snippet; class?: string } = $props();

    /* z-30 is the sticky page-chrome rung: above content and floating surfaces anchored to
       it, below anything fixed to the viewport. */
